...
CREATE TABLE `movie_schedule` (
  ...
  `seatsOfArrayForMovie` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`salon_ID`,`movie_time`,`movie_date`,`movie_ID`),
  KEY `movie_ID` (`movie_ID`),
  CONSTRAINT `movie_schedule_ibfk_1` FOREIGN KEY (`salon_ID`) REFERENCES `salon` (`salon_ID`),
  CONSTRAINT `movie_schedule_ibfk_2` FOREIGN KEY (`movie_ID`) REFERENCES `movie` (`movie_ID`)
...
-- Dump completed on 2022-03-30 14:43:03
